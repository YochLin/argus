...
func botCommands(lang i18n.Lang) []tgbotapi.BotCommand {
	...
	cmds := []cmd{
		...
		{"obuy", "記錄買入選擇權合約", "Record an option buy"},
		{"osell", "記錄賣出選擇權合約", "Record an option sell"},
		{"oassign", "記錄選擇權被指派", "Record an option assignment"},
		{"oexercise", "記錄履約選擇權", "Record an option exercise"},
		{"option", "篩選符合條件的選擇權合約", "Screen option contracts matching a profile"},
		...
		{"morningreport", "手動觸發一次美股開盤簡報", "Run the US morning briefing now"},
		{"monthlyreport", "手動觸發一次月報", "Run the monthly report now"},
		...
		{"paper", "查詢或重置模擬交易", "View or reset paper trading"},
	}
