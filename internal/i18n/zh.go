...
var zhMessages = map[Key]string{
	...
	KeyTWUniverseRefreshed:           "🔄 *台股掃描池已輪替*\n\n依近 5 個交易日成交金額取前 300 檔，新增 %d 檔、移出 %d 檔。\n\n新增：%s",
	...
	KeyUniverseUsage:           "用法：/universe [add|remove] TICKER｜/universe refresh\n不帶參數會顯示掃描池摘要。",
	KeyUniverseRefreshStart:    "🔄 正在向永豐取近 5 個交易日的成交金額排名…",
	KeyUniverseRefreshFailed:   "❌ 掃描池輪替失敗：%v",
	KeyUniverseRefreshNoDaemon: "⚠️ 未設定 SHIOAJI_ADDR，沒有成交金額排名來源，掃描池未變動。",
...
`,
	...
	KeyEvalCountsTitle:           "\n[誠實計數]\n",
	KeyEvalCountHold:             "  未評分（無動作）：%d 筆\n",
	KeyEvalCountCollapsed:        "  連續重複推薦已合併（只算第一筆）：%d 筆\n",
