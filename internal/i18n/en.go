...
var enMessages = map[Key]string{
	...
	KeyStrategyUnvalidated:       "ℹ️ Screen 3 failed out-of-sample validation: negative excess return at ~4σ across three independent samples (cmd/strategyscan). Reference only — not an entry trigger on its own.",
