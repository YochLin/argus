...
const (
	...
	KeyTWUniverseRefreshed         Key = "tw_universe_refreshed"
	KeyUniverseRefreshStart        Key = "universe_refresh_start"
	KeyUniverseRefreshFailed       Key = "universe_refresh_failed"
	KeyUniverseRefreshNoDaemon     Key = "universe_refresh_no_daemon"
	...
	KeyStopUsage            Key = "stop_usage"
	KeyStopNoPosition       Key = "stop_no_position"
	KeyStopInvalidPrice     Key = "stop_invalid_price"
	KeyStopSet              Key = "stop_set"
	KeyStopShow             Key = "stop_show"
	KeyStopNotSet           Key = "stop_not_set"
	KeyStopCandidatesHeader Key = "stop_candidates_header"
	KeyStopCandidateLine    Key = "stop_candidate_line"
	KeyStopLow10Label       Key = "stop_low10_label"
	KeyStopLow20Label       Key = "stop_low20_label"
	KeyStopATRLabel         Key = "stop_atr_label"
	...
	// KeyStopPriceHit is the per-trade-stop-price branch of
	// checkStopLossAlerts (Phase 3.11 PR1 §3.3) — KeyStopLossAlertLine above
	// stays the global-STOP_LOSS_PCT branch, unchanged.
	KeyStopPriceHit             Key = "stop_price_hit"
...
const (
	...
	KeyStrategySqueezeBreakout            Key = "strategy_squeeze_breakout"
	KeyStrategyBoxBottom                  Key = "strategy_box_bottom"
	KeyDaysAgoToday                       Key = "days_ago_today"
	KeyDaysAgoN                           Key = "days_ago_n"
	KeyTechnicalsKDLine                   Key = "technicals_kd_line"
	KeyTechnicalsBandwidthLine            Key = "technicals_bandwidth_line"
	KeyTechnicalsMAAlignLine              Key = "technicals_ma_align_line"
	KeyTechnicalsVolumePriceLine          Key = "technicals_volume_price_line"
	KeyTechnicalsNewHighLine              Key = "technicals_new_high_line"
	KeyTechnicalsMACDZeroLine             Key = "technicals_macd_zero_line"
	...
	KeyStrategyUnvalidatedBoxBottom       Key = "strategy_unvalidated_box_bottom"
	...
	KeyVolDownPriceUp                     Key = "vol_down_price_up"
	KeyVolUpPriceDown                     Key = "vol_up_price_down"
	KeyNewHigh20And52                     Key = "new_high_20_and_52"
	KeyNewHigh20                          Key = "new_high_20"
	KeyNewHigh52                          Key = "new_high_52"
	KeyMACDAboveZero                      Key = "macd_above_zero"
	KeyMACDBelowZero                      Key = "macd_below_zero"
	KeyRSStronger                         Key = "rs_stronger"
	KeyRSWeaker                           Key = "rs_weaker"
	KeyStrategySqueezeName                Key = "strategy_squeeze_name"
	KeyStrategyBoxName                    Key = "strategy_box_name"
)
...
const (
	...
	// KeyRMultipleLine is Phase 3.11 PR1's §3.5 R-multiple line, rendered
	// only when the closed trade had a stop price on record at close time —
	// see ClosedTrade.StopPrice's doc comment for why it's the close-time
	// stop, not the entry-time one.
	KeyRMultipleLine         Key = "r_multiple_line"
	...
	KeyMorningBriefingVIXLine         Key = "morning_briefing_vix_line"
	KeyMorningBriefingNewsHeader      Key = "morning_briefing_news_header"
	...
	KeyNewsTickersLine         Key = "news_tickers_line"
...
const (
	...
	// db.CountPodcastInsightsByURL already has rows for, telling the user
	// their existing insights for this episode are about to be replaced
	// (see db.DeletePodcastInsightsByURL) — sent as its own message ahead
